...
% A label telling the user that this value is their current chip amount
...
% This spinner allows the user to type a value in with their keyboard or
% use buttons on the side.
...
% This alerts the user that the field is typeable, and provides a nice hint
...
% This is the button that finalizes the users chip buying, and takes the
% user to the betting table
uibutton(fig1, 'push',                                       ...
    'BackgroundColor', [0.85 0.85 0.85],          ...
