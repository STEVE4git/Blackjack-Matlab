...
fig_start = uiimage(fig1, 'BackgroundColor', 'Black',                   ...
    ...
    % balance appears in top left corner
        % balance label
balance_label = uilabel(fig1, 'Position', [120 650 125 22],             ...
...
balance = uieditfield(fig1, 'numeric', 'Limits', [0 Inf],               ...
    ...
    % Chip label
chip_label = uilabel(fig1, 'HorizontalAlignment', 'center',             ...
                          'FontSize', 16,                               ...
                          'FontColor', [.8 .8 .8],                      ...
    ...
    % Chip quantity owned
chip_qty = uieditfield(fig1, 'numeric', 'Limits', [0 Inf],         ...
...
deal_btn = uibutton(fig1, 'push', 'BackgroundColor', [0.9 0.9 0.9],     ...
